...
class IndexInfo:
    def __init__(self, idf_arr, max_per_row, word_counts, weights):
...
class Indexer:
    ...
    def make_corpus(self, pages : list):
        ...
        return IndexInfo(self.calculate_idf(ni_counts), max_in_each_row, word_counts, weights)
